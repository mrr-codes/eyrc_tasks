...
class stateMoniter:
    def __init__(self):
        ...
        self.key_list_sorted = list()
        self.row_box_pick_count = [0]*30
        self.list_drone_0 = []
        self.list_drone_1 = []
...
# Function for calculating row search start setpoints from row no. and drone no.
    def calculate_row_start(self, row_no, drone_no):
        ...
        self.boxes_in_row =  self.row_box_pick_count[row_no]
        ...
        if drone_no == 0:
            ...
            if self.boxes_in_row>4:
                return (38, 4*(row_no-17), 3)
            elif self.boxes_in_row > 3:
                return (30, 4*(row_no-17), 3)
            elif self.boxes_in_row >2:
                return (19, 4*(row_no-17), 3)
            elif self.boxes_in_row > 1:
                return (9, 4*(row_no-16), 3)    
            else:
                return(-1.4,4*(row_no-17),3)
...
def drone_0():
    ...
    x = 0  #used so a snippet runs only once when programme begins
        ...
        if i > 4 and (len(setpoints_0)-1):
            ...
            if current_truck_location == 2:
                if len(stateMt.list_drone_0)>0:
                    ...
                    stateMt.row_box_pick_count[required_row] += 1 
                    print('The row and setpoint it is being sent to is' , required_row ,required_row_setpoint)
            ...
            setpoints_0.extend([(stateMt.local_pos_0.x,stateMt.local_pos_0.y,6),required_row_setpoint,(0,0,4)])  #going to 6m alt then box
        ...
        if len(img_proc.Detected_ArUco_markers_0) > 0 and box_dropped == False:
            ...
            if (m < 0):
                ...
                if 0 < img_proc.position_aruco_x_0 < 250:
                    ...
                    pos_0.pose.position.y = required_row_setpoint[1]
            ...
            if m == 0 :
                ...
                vel_0.twist.linear.y = -((((img_proc.position_aruco_y_0 - (200 + 80/stateMt.local_pos_0.z))*stateMt.local_pos_0.z)/400) - ( img_proc.position_aruco_y_0 - (200 + 80/stateMt.local_pos_0.z) - previous_y_error)/40)-vi
            ...
            if(((200 - img_proc.position_aruco_x_0)**2 + (225-img_proc.position_aruco_y_0)**2)<= (img_proc.exo_rad_0)**2) and ((225 <img_proc.position_aruco_y_0-4) and (190<img_proc.position_aruco_x_0)):
                ...
                img_proc.box_setpoint = [stateMt.local_pos_0.x, stateMt.local_pos_0.y]
                ...
                if stateMt.check_gripper_0 == 'True':
                    ...
                    setpoints_0.extend([truck_pts[0], truck_pts[1], (0, 0, 0)])
                    print('d0 Setpoints list as of now', setpoints_0)
                    flag1 = False
                    current_truck_location = box_id

                 #stateMt.actual_box_count[Row] -= 1
                ...
                while x == 0:   
                    ...
                    if len(stateMt.list_drone_0)>0:
                        ...
                        required_row_setpoint = (stateMt.local_pos_0.z, stateMt.local_pos_0.z, stateMt.local_pos_0.z) 
                                                                               ...
                                                                               #runs only once 
                    setpoints_0.extend([required_row_setpoint,(0,4,4)])
                    print('first box target is', required_row_setpoint)
                    x = x+1

                i = i+1                                                                     #main place to increase i 
...
def drone_1():
    ...
    while not rospy.is_shutdown():
        ...
        if i > 4 and (len(setpoints_1)-1):
            ...
            setpoints_1.extend([(stateMt.local_pos_1.x, stateMt.local_pos_1.y,7), required_row_setpoint,(0,0,4)])
            print('The row and setpoint it is being sent to is' , required_row ,required_row_setpoint)
        ...
        if len(img_proc.Detected_ArUco_markers_1) > 0 and box_dropped == False:
            ...
            if (m < 0):
                ...
                if 0 < img_proc.position_aruco_x_1 < 250:
                    ...
                    pos_1.pose.position.y = required_row_setpoint[1]
            ...
            last_pixel_aruco_detected = img_proc.position_aruco_x_1 
            ...
            if reached == True and flag1 == False:
                ...
                while x == 0:
                    ...
                    setpoints_1.extend([required_row_setpoint,(0,4,4)])
                    print('first box target is', required_row_setpoint)
                    x = x+1
