...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if len(img_proc.Detected_ArUco_markers) > 0:
            ...
            vel.twist.linear.x = ((img_proc.position_aruco_x - 200)*stateMt.local_pos.z)/600                         
            vel.twist.linear.y = -((img_proc.position_aruco_y - (200 + 80/stateMt.local_pos.z) )*stateMt.local_pos.z)/600
