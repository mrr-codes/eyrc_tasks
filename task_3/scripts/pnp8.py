    ...
    def image_callback(self, data):
        ...
        try:
            ...
            for key in Detected_ArUco_markers.keys():
                ...
                #self.distance_x_m= self.distance_x*0.002645833
                # self.distance_y_m=self.distance_y*0.002645833
...
def main():
    ...
    setpoints = [(0, 0, 3), (9, 0, 3), (9, 0, 3), (9, 0, 3),
    ...
    while not rospy.is_shutdown():
        ...
        if reached == True and (i == 2 or i == 3 or i == 5):
            ...
            # if 10 < img_proc.distance_x < 20:
            #     print('Box is at ', max(x))
            #     rospy.sleep(3)
            #     ofb_ctl.setAutoLandMode()
            #     land_count += 1
            ...
            if land_count == 1 and stateMt.check_gripper == 'True':
        ...
        if reached == True and land_count < 4:
            print("off", i)
            i = i+1
