...
def drone_1():
    ...
    setpoints_1 = [(0, 0, 3), (-1, -12, 3),
                   (58, 0, 3), (58, 0, 3), (58.35, 3.75, 1.8), (58.35, 3.75, 3), (-1, -28, 3), (-1, -32, 3), (58, 0, 3), (59, 0, 3), (59.2, 3.75, 1.8), (65, 0, 3), (0, 0, 3)]
    ...
    while not rospy.is_shutdown():
        ...
        if len(img_proc.Detected_ArUco_markers_1) > 0 and box_dropped == False:
            ...
            img_proc.aruco_thresh_bool = True
            vel_1.twist.linear.x = (((img_proc.position_aruco_x_1 - 200)*stateMt.local_pos_1.z)/550 - (
            ...
            if img_proc.bcorner[0] < (200) < img_proc.position_aruco_x_1 and img_proc.position_aruco_y_1 < (225) < img_proc.bcorner[1]:
