...
def drone_0():
    ...
    setpoints_0 = [(0, 0, 3), (0, 14, 3), (0, 16, 3), (17.4, -7.17, 5), (17.4, -7.17, 5), (17.4, -7.17, 1.84), (17.4, -7.17, 5),
                   (-1, 18, 3), (-1, 24, 3), (16.55, -7.17, 5), (16.55, -7.17, 5), (16.55, -7.17, 1.84), (16.55, -7.17, 5), (0, 0, 3)]
  # List to setpoints
    ...
    while not rospy.is_shutdown():
        ...
        if len(img_proc.Detected_ArUco_markers_0) > 0 and box_dropped == False:
            ...
            if i == 9:
                ...
                vel_0.twist.linear.y = -((((img_proc.position_aruco_y_0 - (200 + 80/stateMt.local_pos_0.z))*stateMt.local_pos_0.z)/250) - (
                    img_proc.position_aruco_y_0 - (200 + 80/stateMt.local_pos_0.z) - previous_y_error)/40)-0.05
...
def drone_1():
    ...
    setpoints_1 = [(0, 0, 3), (0, -12, 3),
                   (58, 0, 3), (58, 3.7, 5), (58.35, 3.75, 1.8), (58.35, 3.75, 5), (-1, -34, 3), (-1, -32, 3), (58, 0, 5), (59, 0, 5), (59.2, 3.75, 1.8), (59, 0, 5), (0, 0, 3)]
